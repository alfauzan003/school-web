                ...
                <div class="container-fluid">
                    ...
                    <!-- Row -->
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="multiLevel_input.php" class="form-horizontal form-material">
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">ID Student</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input required type="text" name="id_student" placeholder="ID Student yang sudah terdaftar" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Nama</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input required type="text" name="nama" placeholder="Masukkan Nama" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Bahasa Indonesia</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input required type="text" name="bahasaIndonesia" placeholder="00" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Matematika</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input required type="text" name="matematika" placeholder="00" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Fisika</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input required type="text" name="fisika" placeholder="00" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <div class="col-sm-12">
