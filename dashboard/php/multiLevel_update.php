...
?>
    ...
    <body>
        <?php
            ...
            $data=mysqli_query($konek, "SELECT * FROM nilai WHERE id_student='$id_student'");
                ...
                <div class="container-fluid">
                    ...
                    <!-- Row -->
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="multiLevel_koneksiupdate.php" class="form-horizontal form-material">
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">ID Student*</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input readonly type="text" name="id_student" value="<?php echo $hasil['id_student']; ?>" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Nama</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input type="text" name="nama" value="<?php echo $hasil['nama']; ?>" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Bahasa Indonesia</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input required type="text" name="bahasaIndonesia" value="<?php echo $hasil['bahasaIndonesia']; ?>" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Matematika</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input required type="text" name="matematika" value="<?php echo $hasil['matematika']; ?>" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Fisika</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input required type="text" name="fisika" value="<?php echo $hasil['fisika']; ?>" class="form-control p-0 border-0"> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <div class="col-sm-12">
...
<?php
    }else {echo "<script>alert('Data gagal diupdate, Anda bukan Guru');window.location='../html/multiLevel_404.html'</script>";}    
?>